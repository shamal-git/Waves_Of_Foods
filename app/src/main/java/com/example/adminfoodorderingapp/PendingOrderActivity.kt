...
class PendingOrderActivity : AppCompatActivity(), PendingOrderAdapter.OnItemClicked {
    ...
    private fun deleteThisItemFromOrderDetails(dispatchItemPushKey: String){
        val orderDetailItemsReference = database.reference.child("OrderDetails").child(dispatchItemPushKey)
        orderDetailItemsReference.removeValue()
            .addOnSuccessListener {
                Toast.makeText(this, "Order is Dispatched.", Toast.LENGTH_SHORT).show()
            }
            .addOnFailureListener {
                Toast.makeText(this, "Order is failed to Dispatched.", Toast.LENGTH_SHORT).show()
